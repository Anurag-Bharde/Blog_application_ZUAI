...
export function Signup() {
    ...
    async function handleSignup(e) {
        ...
        try {
            ...
            setTimeout(() => navigate("/BlogList"), 500);
        } catch (err) {
            setIsSubmitting(false); 
        ...
        <div className="flex h-screen">
            ...
            <div className="w-4/6 flex items-center justify-center min-h-screen bg-[#e5ecf3]">
                <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                    ...
                    {isSubmitting ? (
                        <div className="text-center">Submitting your details, please wait...</div> 
                    ) : (
            ...
            {isNavigating && <div className="overlay">Navigating, please wait...</div>} 
        </div>
    );
}
